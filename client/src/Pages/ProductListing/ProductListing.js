...
/**
 * Component for ProductListing page
 */
const ProductListing = () => {
  ...
  const cartDialogAction = () => {
    return (
      <div className="cart_action">
        <span className="promo-label">Promo code can be applied on payment page</span>
        <a class="checkout-cart-btn" href="#">
  ...
  return (
    <>
      <Header />
      <main class="main-body-height">
        <section className="products-listing-section-style">
          <div className="container grid--2-cols--product-listing  ">
            <nav class="side-nav">
              {' '}
            ...
            <section>
              <div className="products-listing-container grid grid--4-cols ">
                {products?.length ? (
      ...
      <Footer className="container-row-3" customStyle="sticky-footer" />
      <DialogBox
        open={true}
        dialogId={'cart-diag-popup'}
        title={'Alert'}
        showClose={false}
        customStyle="cartDiagBody"
        customDialogAction={cartDialogAction()}
      >
        {' '}
        <div id="cart-body-div" className="">
          {' '}
          <ul className="cart-body-list">
            <li className="cart-list-item">
              <img src={images['apple.jpg']} className="cart-img" alt="cart product image"></img>
              <div className="cart-item-count-container">
                <div className="cart-item-label">
                  {' Apple - Washington, Regular, 4 pcs' &&
                  ' Apple - Washington, Regular, 4 pcs'?.length < 108
                    ? ' Apple - Washington, Regular, 4 pcs'
                    : `${' Apple - Washington, Regular, 4 pcs'?.substring(0, 108)}...`}
                </div>
                <div className="cart-item-count">
                  <a class="cart-control-btn" href="#">
                    {`-`}
                  </a>
                  <span className="cart-price">{1}</span>
                  <a class="cart-control-btn" href="#">
                    {`+`}
                  </a>
                  <span className="cart-price">{'x'}</span>
                  <span className="cart-price">Rs.{187}</span>
                </div>
              </div>
              <div className="cart-item-price-container">
                <span className="cart-total-price">Rs.{187}</span>
              </div>
            </li>
            <li></li>
          </ul>
